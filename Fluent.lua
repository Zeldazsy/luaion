...
local Themes = {
	...
	Zelda = {
		Name = "Zelda",
		Accent = Color3.fromRGB(85, 57, 139),

		AcrylicMain = Color3.fromRGB(20, 20, 20),
		AcrylicBorder = Color3.fromRGB(110, 90, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(102, 0, 102), Color3.fromRGB(40, 25, 65)),
		AcrylicNoise = 0.92,
...
if ToggleLib then
	...
	function SwapIco()
		if not Library.Window.Minimized then
			Background.Icon.Image = "rbxassetid://9886659276"
		else
			Background.Icon.Image = "rbxassetid://9886659671"
		end
	end
